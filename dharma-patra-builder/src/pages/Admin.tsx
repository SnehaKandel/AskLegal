  ...
  return (
    <MainLayout>
      <div className="container mx-auto py-8 px-4">
        <h1 className="text-3xl font-bold text-asklegal-purple mb-8">Admin Dashboard</h1>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-asklegal-purple/30">
                    <th className="text-left py-4 px-2 text-white/70 font-medium">Name</th>
                    <th className="text-left py-4 px-2 text-white/70 font-medium">Email</th>
                    <th className="text-left py-4 px-2 text-white/70 font-medium">Role</th>
                    <th className="text-left py-4 px-2 text-white/70 font-medium">Status</th>
                    <th className="text-left py-4 px-2 text-white/70 font-medium">Last Active</th>
                    <th className="text-right py-4 px-2 text-white/70 font-medium">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {users.map(user => (
