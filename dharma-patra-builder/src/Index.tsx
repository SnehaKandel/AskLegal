    ...
    <MainLayout>
      <div className="container mx-auto py-16 px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-asklegal-dark/60 border border-asklegal-purple/30 rounded-lg p-6">
            <h3 className="text-xl font-medium text-white mb-3">Legal Forms</h3>
            <p className="text-white/70 mb-4">Access and fill out important legal forms and documents.</p>
