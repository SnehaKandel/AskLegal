...
import { FileText, BookOpen, User, LogIn, LogOut, Moon, Sun, Search, BookAudio, Languages, CalendarClock, ChevronDown, Bot, Upload } from 'lucide-react';
        ...
        <div className="flex items-center gap-6">
          ...
          {user?.role === 'admin' && (
            <>
              ...
              <Link to="/documents" className="flex items-center text-asklegal-heading hover:text-asklegal-purple gap-2 theme-transition">
                <Upload size={18} />
